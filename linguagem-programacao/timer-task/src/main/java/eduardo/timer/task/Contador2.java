 ...
 * @author eduardo
 */
public class Contador2 extends javax.swing.JFrame {

    /** Creates new form Contador2 */
    public Contador2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        lblContador.setFont(new java.awt.Font("Liberation Sans", 0, 36)); // NOI18N
    ...
    private void btnIniciarSomaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarSomaActionPerformed
        new Timer().scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                contador += 10;
                lblContador.setText(contador.toString());
            }
        }, 0, 5000);
